    ...
    <div className={professionalClass} ref={professional}>
      ...
      <div className="container">
        ...
        <article className="content">
          <p className="text">
            　　我喜歡自學，透過網路學習前端技術，像是 Udemy、Hahow 好學校…等，藉由課程快速吸收並增加自己的專業視野與水平。透過網路課程學習 HTML、CSS、JavaScript，邊學邊做累積經驗。
          </p>
          <p className="text">
          ...
          <p className="text">
            　　其後從事為期三年左右的前端工程師職務，設計規劃並透過程式碼實現網頁動態效果、滿足產品規格需求、串接後端等，也不斷吸收前端網頁新知，對於學習前端技術有十足的熱誠。
          </p>
        </article>
      </div>
    </div>
